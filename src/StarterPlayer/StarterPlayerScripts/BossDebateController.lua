...
function Controller.Init(remotes,parent,buttonFactory,labelFactory,colors)
 ...
 local topicPicker=Instance.new("Frame");topicPicker.Position=UDim2.fromOffset(16,108);topicPicker.Size=UDim2.new(1,-32,0,286);topicPicker.BackgroundColor3=colors.bg;topicPicker.Visible=false;topicPicker.ZIndex=5;topicPicker.Parent=practice

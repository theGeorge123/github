...
local C = { navy=Color3.fromRGB(13,20,36), blue=Color3.fromRGB(35,65,94), cyan=Color3.fromRGB(80,220,232), gold=Color3.fromRGB(255,194,82), green=Color3.fromRGB(89,190,130), white=Color3.fromRGB(235,242,250) }
...
local function bot(root,name,x,color,shape)
 ...
 local tag=Instance.new("BillboardGui");tag.Size=UDim2.fromOffset(220,52);tag.StudsOffset=Vector3.new(0,2,0);tag.AlwaysOnTop=true;tag.Parent=h
...
function World.Init()
 ...
 part("Stage",Vector3.new(24,1,20),Vector3.new(0,0,0),C.navy,root,Enum.Material.Slate)
 ...
 Lighting.ClockTime=14;Lighting.Brightness=2.6;Lighting.Ambient=Color3.fromRGB(110,125,145);Lighting.OutdoorAmbient=Color3.fromRGB(135,145,160)
 return root
end

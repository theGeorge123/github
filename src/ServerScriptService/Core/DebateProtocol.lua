local Protocol = {}
local VALID_KINDS = {Lobby=true,Profile=true,Start=true,Turn=true,PlayerTurn=true,AIReply=true,ArgumentRejected=true,Complete=true,RematchStatus=true,Ended=true}

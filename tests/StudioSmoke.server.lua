...
assert(second and second ~= match, "Arena did not release")
...
print("BEAT_THE_BOT_SMOKE_PASS: win, protocol, persistence, idempotency, arena reuse, forfeit, counters, leaderstats")
